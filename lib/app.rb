...
def hello_journalist
	...
	five_journalist = journalists.sample(5)

	five_journalist.each do |name|
		client.update("Bonjour #{name}, j espere que ta journée se passe bien! #bonjour_monde")
	end
end
...
def follow_hello
	client = login_twitter
	followers_array = []																																																																																																																																																																																																																																																																																																																																																																																													
	client.search('#bonjour_monde', result_type: "recent").take(60).collect do |tweet|
